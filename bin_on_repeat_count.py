...
if __name__ == "__main__":
        ...
        group.add_option("--param", default=" -c 2 -t 0 -j 2 ", dest="param", metavar="[STRING]", help="pbdagcon paramteres [default = -m 70 -c 2 -t 0 -j 2 ]")
        ...
        group.add_option("--rf", default="/hpc/cog_bioinf/GENOMES/Cyclomics_reference_genome/version8/Homo_sapiens.GRCh37.GATK.illumina_cyclomics_backbone.fasta", dest="refgenome_full", metavar="[PATH]", help="full path to complete reference genome [default = /hpc/cog_bioinf/GENOMES/Cyclomics_reference_genome/version8/Homo_sapiens.GRCh37.GATK.illumina_cyclomics_backbone.fasta]")
...
param=" -m "+opt.cons_len+opt.param
